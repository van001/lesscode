...
/** Function */
const laddNumbers2 = lst1 => lst2 => $p(s2List2(blank), sreverse, sZInteger)(add2(lXfoldR2Int(lst1))(lXfoldR2Int(lst2)))

/** Test */
const data = [[[2, 4, 3], [5, 6, 4], [7, 0, 8]]]

data.forEach(val => assert(laddNumbers2(val[0])(val[1]))(val[2])(`${val}`))
