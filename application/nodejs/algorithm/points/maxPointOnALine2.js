...
const laddIndex = lst => lst.reduce((acc, val, index) => {print(val);return val},[])
...
const l2indexMap = lst => lst.reduce((map, val, index) => {(map[val])? map[val].push(index) : map[val] =[index]; return map},{})
 ...
 * Your solution should be composable than building from scratch everytime.
...
const lmaxSlope = lst => {
    ...
    return $(  
       // trace('Add 1 to inlude original point...... '), add(1),
        ...
        trace('Add index........................... '), lmap(laddIndex),
        trace('Convert Map 2 List (value).......... '), lmap(m2ValList),
        trace('Generate index Map.................. '), lmap(l2indexMap),
